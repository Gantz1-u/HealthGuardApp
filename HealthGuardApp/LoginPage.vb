...
Public Class LoginPage
    ...
    Private Sub RoundedButton3_Click(sender As Object, e As EventArgs) Handles RoundedButton3.Click
        ...
        Dim password = RoundedTextBox3.Text.Trim
        ...
        Dim query = "SELECT UserID, Role, Status FROM accounts WHERE EmailUsername = @EmailUsername AND Password = @Password"
        ...
        Try
            ...
            Using cmd As New MySqlCommand(query, connection)
                ...
                If reader.HasRows Then
                    ...
                    Dim userRole = reader("Role").ToString.Trim
                    Dim userStatus = reader("Status").ToString.Trim
    ...
    Private Sub RoundedTextBox3_KeyDown(sender As Object, e As KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
            e.SuppressKeyPress = True
