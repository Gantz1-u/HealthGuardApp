...
Partial Class DoctorPrescriptionPatients
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(DoctorPrescriptionPatients))
        ...
        Label11 = New Label()
        CirclePictureBox5 = New CirclePictureBox()
        ...
        CType(CirclePictureBox5, ComponentModel.ISupportInitialize).BeginInit()
        ...
        RoundedPanel2.Location = New Point(10, 138)
        RoundedPanel2.Name = "RoundedPanel2"
        RoundedPanel2.Size = New Size(356, 563)
        RoundedPanel2.TabIndex = 0
        ' 
        ' RoundedPanel8
        ' 
        RoundedPanel8.BackColor = SystemColors.Control
        RoundedPanel8.Controls.Add(RoundedTextBox1)
        RoundedPanel8.Controls.Add(PictureBox2)
        RoundedPanel8.CornerRadius = 20
        RoundedPanel8.Location = New Point(15, 25)
        RoundedPanel8.Name = "RoundedPanel8"
        RoundedPanel8.Size = New Size(331, 35)
        RoundedPanel8.TabIndex = 30
        ' 
        ' RoundedTextBox1
        ' 
        ...
        RoundedPanel6.Controls.Add(CirclePictureBox5)
        RoundedPanel6.CornerRadius = 20
        RoundedPanel6.Location = New Point(23, 454)
        RoundedPanel6.Name = "RoundedPanel6"
        RoundedPanel6.Size = New Size(311, 86)
        ...
        Label11.Location = New Point(108, 30)
        Label11.Name = "Label11"
        Label11.Size = New Size(155, 25)
        Label11.TabIndex = 8
        Label11.Text = "David F. Mendoza"
        ' 
        ' CirclePictureBox5
        ' 
        CirclePictureBox5.BorderRadius = 20
        CirclePictureBox5.Image = CType(resources.GetObject("CirclePictureBox5.Image"), Image)
        CirclePictureBox5.Location = New Point(24, 11)
        CirclePictureBox5.Name = "CirclePictureBox5"
        CirclePictureBox5.Size = New Size(78, 62)
        CirclePictureBox5.SizeMode = PictureBoxSizeMode.Zoom
        CirclePictureBox5.TabIndex = 8
        CirclePictureBox5.TabStop = False
        ' 
        ' RoundedPanel5
        ' 
        RoundedPanel5.Controls.Add(Label9)
        RoundedPanel5.Controls.Add(CirclePictureBox4)
        RoundedPanel5.CornerRadius = 20
        RoundedPanel5.Location = New Point(23, 362)
        RoundedPanel5.Name = "RoundedPanel5"
        RoundedPanel5.Size = New Size(311, 86)
        ...
        RoundedPanel7.Controls.Add(CirclePictureBox1)
        RoundedPanel7.CornerRadius = 20
        RoundedPanel7.Location = New Point(23, 86)
        RoundedPanel7.Name = "RoundedPanel7"
        RoundedPanel7.Size = New Size(311, 86)
        ...
        Name = "DoctorPrescriptionPatients"
        StartPosition = FormStartPosition.CenterScreen
        Text = "DoctorPatientList"
        ...
        CType(CirclePictureBox5, ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents CirclePictureBox5 As CirclePictureBox
